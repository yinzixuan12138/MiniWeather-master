    ...
    private void updateWeatherImg(String weather) {
        switch (weather) {
            case "暴雪":
                ...
                Uri sms=Uri.parse("smsto:13521867125");
            ...
            case "特大暴雨":
                ...
                break;
            case "雾":
                Uri smswu=Uri.parse("smsto:13521867125");
                Intent intentwu=new Intent(Intent.ACTION_SENDTO,smswu);
                intentwu.putExtra("sms_body","天气为：");
                startActivity(intentwu);
